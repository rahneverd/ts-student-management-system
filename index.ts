...
class StudentManagementSystem {
    ...
    private availableCourses: CourseModel[] = [{
    ...
    getStudentById(studentId: number): StudentModel | undefined {
        return this.students.find(student => student.StudentId === studentId);
    }

    enrollCourse(studentId: number, selectedCourses: string[]): void {
    ...
    payTuition(studentId: number, amount: number): void {
        const student = this.getStudentById(studentId);
        if (student) {
    ...
    getStudentsList(): StudentModel[] {
        return this.students;
    }

    getCoursesList(): CourseModel[] {
